...
export interface IFastProgram extends IProgram {
    render(params: any): void
}

const ATTRIBUTES = 5;
export abstract class AbstractFastProgram extends AbstractProgram implements IFastProgram {
    ...
    constructor(
        ...
        if (background == null) console.warn('Fast:  获取不到background')
...
export interface NodeProgramConstructor {
    new (gl: WebGLRenderingContext): IFastProgram
}
